...
// Twitter bootstrap-friendly HTML boilerplate for standard inputs
    jsonform.fieldTemplate = function(inner) {
        return '<div class="<%= cls.groupClass %> <%= elt.groupHtmlClass %> jsonform-node jsonform-error-<%= keydash %>' +
    ...
    jsonform.elementTypes = {
        ...
        'array': {
            ...
            'onInsert': function (evt, node) {
                ...
                var addItem = function (idx,AfterInsert) {
                ...
                var deleteItem = function (idx,AfterDelete) {
                ...
                $('> span > a._jsonform-array-addmore', $nodeid).click(function (evt) {
                    ...
                    addItem(idx,node.formElement.afterInsert);
                });
                ...
                $('> span > a._jsonform-array-deletelast', $nodeid).click(function (evt) {
                    ...
                    evt.preventDefault();
                    evt.stopPropagation();
                    deleteItem(idx,node.formElement.afterDelete);
                });
        ...
        'section': {
            'template': '<div' +
            '<% if (node.id) { %> id="<%= node.id %>"<% } %> class="jsonform-node row jsonform-error-<%= keydash %> <%= elt.htmlClass?elt.htmlClass:"" %>"' +
            '><%= children %></div>'
        },
