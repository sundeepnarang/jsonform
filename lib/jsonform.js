...
formTree.prototype.buildTree = function () {
  ...
  if(this.formDesc.form.indexOf("*")!=-1){
    if(this.formDesc.form.length==1){
      ...
      var formKeyDictObject = {};
      var formKeyOtherElemets = [];
      _.each(this.formDesc.form, function (formElement) {
        ...
        if(formElement.key) formKeyDictObject[formElement.key] = formElement;
        else formKeyOtherElemets.push(formElement);
      });

      _.each(this.formDesc.schema.properties, function (element, key) {
        if(formKeyDictObject[key]){
          this.root.appendChild(this.buildFromLayout(formKeyDictObject[key]));
        }else {
          this.root.appendChild(this.buildFromLayout({
            key: key
          }));
      ...
      _.each(formKeyOtherElemets, function (element, key) {
          this.root.appendChild(this.buildFromLayout(element));
      }, this);
